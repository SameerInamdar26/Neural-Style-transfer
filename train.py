...
def parse_arguments():
    ...
    parser.add_argument('--vgg', type=str, default='encoder_weights.pth',
                        help='Location of pre-trained VGG')
    parser.add_argument('--experiment', type=str, default='nst_model_v1',
...
def main():
    ...
    save_dir = Path('training_runs') / args.experiment
